...
//                   <TableCell
//                     sx={{
//                       color: user.eventPass.isPresent ? "#006400" : "red", // Dark green or red text
//                       fontWeight: "bold",
//                       backgroundColor: user.eventPass.isPresent
//                         ? "#ccffcc"
//                         : "#ffcccc", // Light green or light red background
...
//                   <TableCell
//                     sx={{
//                       color: user.eventPass.userCreated ? "#006400" : "red", // Dark green or red text
//                       fontWeight: "bold",
...
//         // Update the user status in the table to green (sent)
//         setUsers((prevUsers) =>
//           prevUsers.map((user) =>
...
//                 "Attendance",
//                 "User Created",
//                 "Pass Sent", // Add this header for the button
//               ].map((header) => (
//                 <TableCell
//                   key={header}
//                   sx={{
...
//                     <Button
//                       variant="contained"
//                       color={user.eventPass.passSent ? "success" : "error"} // Green for Sent, Red for Not Sent
//                       onClick={() => handleMarkAsSent(user.userId)}
//                       disabled={user.eventPass.passSent} // Disable if already marked as sent
//                       sx={{
//                         fontWeight: user.eventPass.passSent ? "bold" : "normal", // Bold when Sent
//                         color: user.eventPass.passSent ? "#FFFFFF" : "black", // White text for Sent, Black for Not Sent
//                         backgroundColor: user.eventPass.passSent
//                           ? "#388E3C" // Green background for Sent
//                           : "#FFD700", // Yellow background for Not Sent
//                         "&:hover": {
//                           backgroundColor: user.eventPass.passSent
//                             ? "#2C6B32" // Darker green on hover for Sent
//                             : "#d32f2f", // Darker red on hover for Not Sent
//                         },
...
//                           ? "0 4px 12px rgba(0, 100, 0, 0.3)" // Shadow effect for Sent
//                           : "0 4px 12px rgba(255, 0, 0, 0.3)", // Shadow effect for Not Sent
//                         transition:
//                           "background-color 0.3s ease, box-shadow 0.3s ease", // Smooth transition for hover and background change
//                       }}
//                     >
...
//       } else {
//         setSearchResults(response.data.users); // Populate search results
//       }
//     } catch (error) {
...
//   const handleSearchInputChange = (field, value, callback) => {
//     setSearchParams((prevParams) => {
//       // Only update state if the value has changed
//       if (prevParams[field] !== value) {
//         const updatedParams = { ...prevParams, [field]: value };

//         // Optional callback to perform additional actions
//         if (callback) {
...
//           onChange={(e) => {
//             handleSearchInputChange("userId", e.target.value);
//           }}
//           size="small"
//         />
//         <TextField
...
//           onChange={(e) =>
//             debouncedHandleSearchInputChange("fullName", e.target.value)
//           }
//           size="small"
//         />
//         <TextField
...
//             debouncedHandleSearchInputChange("occupation", e.target.value);
//           }}
//           size="small"
//         />
//         <TextField
...
//           onChange={(e) =>
//             debouncedHandleSearchInputChange("email", e.target.value)
//           }
//           size="small"
//         />
//         <TextField
...
//           onChange={(e) =>
//             debouncedHandleSearchInputChange("mobileNo", e.target.value)
//           }
//           size="small"
//         />
//         <TextField
...
//           onChange={(e) =>
//             debouncedHandleSearchInputChange("passNumber", e.target.value)
//           }
//           size="small"
//         />
